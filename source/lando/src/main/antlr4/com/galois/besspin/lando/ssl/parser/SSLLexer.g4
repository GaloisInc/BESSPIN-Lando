...
NP_EMPTYLINE	    : F_EMPTYLINE -> type(EMPTYLINE), popMode ;
...
NPR_EMPTYLINE	    : F_EMPTYLINE -> type(EMPTYLINE), popMode ;
...
IL_EMPTYLINE	    : F_EMPTYLINE -> type(EMPTYLINE), popMode, pushMode(MODE_SINGLE_SENTENCE) ;
