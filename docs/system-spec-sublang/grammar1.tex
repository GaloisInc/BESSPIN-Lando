...
\begin{grammar}
  ...
  \grule{\gntn{system}}{
    ...
    \gntn{explanation}  % assuming ends a genuine blank line \gnl\gnl  ??
    \gopt{\glistnonempty{\gnl} \gntn{indexing}} 
    \gntn{blockend}
  }{System}
  ...
  \grule{\gntn{component}}{
    ...
    \gntn{explanation}  % assuming ends a genuine blank line \gnl\gnl  ??
    \glist{\glistnonempty{\gnl} \gntn{componentFeature}}
    \gntn{blockend}
  }{Component}
  ...
  \grule{\gntn{nameWord}}{
    \gtregex{[\gtneg\gtesc{r}\gtesc{n} \gtesc{t}()]*[\gtneg\gtesc{r}\gtesc{n} \gtesc{t}().!?]} 
  }{Name word}
  ...
  \grule{\gntn{indexNameWord}}{
    \gtregex{[\gtneg\gtesc{r}\gtesc{n} \gtesc{t}:]+}
  }{Index name word}
  ...
  \grule{\gntn{elemNameWord}}{
    \gntn{nameWord} \text{except not \gtkw{inherit}, \gtkw{client}, or \gtkw{contains}}
  }{Element name word}
  
  \gline

  \grule{\gntn{paragraph}}{
    \glistnonempty{\gntn{sentence}}
  }{Paragraph}

  \grule{\gntn{sentence}}{
    \gntn{sentBody} \gntn{sentTerm} \gopt{\gntn{wordSep}} \gcont
    \gor \gntn{sentBody} \gopt{\gntn{wordSep}} % issues warning
  }{Sentence}
  ...
  \grule{\gntn{wordSep}}{
    \glistnonempty{\gns} \gor \glist{\gns} \gnl \glist{\gns}
  }{Word Separator}
  ...
  \grule{\gnl}{
    \gtregex{(\gtkc{\gtesc{r}}?\gtkc{\gtesc{n}})|\gtkc{\gtesc{r}}} \gopt{\gns} \gor \gntn{EOF}
  }{Line separator}

  \grule{\gnc}{
    \gtkc{/}\gtkc{/} \gtregex{[\gtneg\gtesc{r}\gtesc{n}]*}
  }{Comment}
...
The following extra-grammatical rules are applied after parsing the concrete grammar above.
...
\item 
  Each \gntn{relationClause} is translated into a top-level \gntn{relation} declaration.
\end{itemize}
