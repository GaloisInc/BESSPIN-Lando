...
\newcommand{\sydataval}[3]{\langle #1, #2, #3 \rangle}
\newcommand{\sydatavaldef}{
  \sydataval{\setof{\subsystem}}{\explanation}{\indexing}
} 
...
\newcommand{\indexmapvaldef}{\indexmapval{\indexparent}{\indexpropmapex}}
\newcommand{\indexparent}{\mathbb{SS}}
\newcommand{\indexpropmap}[2]{\{#1 \mapsto #2\}}
\newcommand{\indexpropmapex}{\indexpropmap{\semprop}{\semvalue}}
