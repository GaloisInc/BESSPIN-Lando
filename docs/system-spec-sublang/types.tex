...
\begin{grammar}
  ...
  \gruleplain{\subsystem \intro \subsystem}{Subsystem Containment 1}
  ...
  \gruleplain{\scenarios \intro \scenario}{Event Introduction}
  \gruleplain{\subsystem \intro \requirements}{Event Set Introduction}
  \gruleplain{\requirements \intro \requirements}{Event Introduction}
\end{grammar}
...
\begin{grammar}
  ...
  \grule{\tp}{\tbool \gor \tint \gor \tnat 
               \gor \tsystem \gor \tsubsystem \gor \tcomponent 
               \gor \tevent \gor \tscenario \gor \trequirement}{Primitive Type}
