...
\begin{grammar}
  ...
  \gline
  \gruleplain{\indexing  \intro \semprop}{Semantic Property Introduction}
  \gline
  ...
  \gline
  \gruleplain{\system \intro \events}{Event Set Introduction}
  \gruleplain{\events \intro \event}{Event Introduction}
  \gruleplain{\system \intro \scenarios}{Scenarios Set Introduction}
  \gruleplain{\scenarios \intro \scenario}{Scenario Introduction}
  \gruleplain{\system \intro \requirements}{Requirements Set Introduction}
...
\begin{grammar}
  ...
  \grule{\esdmap}{\mapof{\events}{\esdmapvaldef}}{Event Set Data Map}
  ...
  \grule{\scsdmap}{\mapof{\scenarios}{\scsdmapvaldef}}{Scenario Set Data Map}
  ...
  \grule{\rsdmap}{\mapof{\requirements}{\rsdmapvaldef}}{Requirement Set Data Map}
...
\begin{mathparpagebreakable}
  ...
  \bbrule{Subsystem Containment 1}{
    ...
    \subsystem \mapsto \tv \in \tstmap \\
    \tv \mapsto \sdmapval{\subsystemparent}{\_}{\_}{\_}{\_} \in \tsdmap \\
  ...
  \bbrule{Semantic Property Introduction}{
    ...
    \semprop \in \setof{\semprop} \\
    \tv \mapsto \typeof(\tenv, \indexparent) \\
  }{
    \tenv \timpl \indexing  \intro \semprop \hastype \tv
  }

  \bbrule{Event Set Introduction}{
    \tsydata = \sydatavaldef \\
    \events \in \setof{\events} \\
    \events \mapsto \esdmapval{\system}{\_} \in \tesdmap \\
  }{
    \tenv \timpl \system \intro \events \hastype \tsystem
  }
  
  \bbrule{Event Introduction}{
    \events \mapsto \esdmapvaldef \in \tesdmap \\
    ...
    \tenv \timpl \events \intro \event \hastype \tsystem 
  }

  \bbrule{Scenario Set Introduction}{
    \tsydata = \sydatavaldef \\
    \scenarios \in \setof{\scenarios} \\
    \scenarios \mapsto \scsdmapval{\system}{\_} \in \tscsdmap \\
  }{
    \system \intro \scenarios \hastype \tsystem
  }

  \bbrule{Scenario Introduction}{
    \scenarios \mapsto \scsdmapvaldef \in \tscsdmap \\
    ...
    \scenarios \intro \scenario \hastype \tsystem
  }
  ...
  \bbrule{Requirement Set Introduction}{
    ...
    \tv \mapsto \scsdmapval{\system}{\_} \in \trsdmap \\
  }{
    \system \intro \requirements \hastype \tsystem
  }

  \bbrule{Requirement Introduction}{
    \requirements \mapsto \rsdmapvaldef \in \trsdmap \\
    ...
    \requirements \intro \requirement \hastype \tsystem
  }
