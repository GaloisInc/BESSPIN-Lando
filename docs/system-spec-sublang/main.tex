...
\begin{grammar}
  ...
  \grule{\gnsubsystem}{
    \gnlinecomments \gtkw{subsystem} \gnnamephraserel \gopt{\gnrelkeyword \gnnamephrase} \gncomment \gnnl \gcont
    \; \gnexplanation \gnnl \gcont
    \; \gopt{\gnnl \gtkw{indexing} \gopt{\gnnl \gnindexing}} \gcont
  ...
  \grule{\gncomponent}{
    \gnlinecomments \gtkw{component} \gnnamephraserel \gopt{\gnrelkeyword \gnnamephrase} \gncomment \gcont
  ...
  \grule{\gnkeyword}{
    ...
    \gtkw{events} \gtkw{scenarios} \gor \gtkw{requirements} \gor \gtkw{relation}
  }{All\ Keywords}
