...
\begin{grammar}
  ...
  \grule{\gntn{containsClause}}{
    \gtkw{contain} \gntn{qname} \glist{\gnl} \glist{\gtkc{,} \glist{\gnl} \gntn{qname} \glist{\gnl}}
  }{Client clause}
  ...
  \grule{\gntn{relation}}{
    \glist{\gnc\gnl}
    \gtkw{relation} \gntn{qname} \glistnonempty{\gntn{inheritClause} \gor \gntn{clientClause} \gor \gntn{containsClause}}
    \gopt{\gnc}
    \gntn{blockend}
...
\item
  \gntn{subystemImport} can only appear in an (explicit or implicit) \gntn{system} or \gntn{subsystem}
