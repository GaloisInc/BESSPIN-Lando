...
\begin{grammar}
  ...
  \grule{\gntn{system}}{
    ...
    \gntn{explanation}  \gopt{\gnc}
    \gopt{\gntn{indexing} \gntn{blockend}} \gcont
    \gopt{\gtkw{contains} \gntn{sysBody} \gtkw{end} \gntn{blockend}}
  }{System}

  \grule{\gntn{sysBody}}{
    \glist{\gntn{sysElement}}
  }{System body}

  \grule{\gntn{sysElement}}{
    \gntn{subsystem} \gor \gntn{events} \gor \gntn{scenarios} \gor \gntn{requirements} \gor \gntn{relation}
  }{System element}
  
  \grule{\gntn{subsystem}}{
    \glist{\gnc\gnl}
    \gtkw{subsystem} \gntn{name} \gopt{\gntn{abbrev}} (\gntn{subsysDef} \gor \gntn{subsysImport})
  }{Subsystem}
  
  \grule{\gntn{subsysDef}}{
    \glist{inheritClause \gor clientClause} \gopt{\gnc} \glistnonempty{\gnl} \gcont
    \gntn{explanation}  \gopt{\gnc}
    \gopt{\gntn{indexing} \gntn{blockend}} \gcont
    \gopt{\gtkw{contains} \gntn{subsysBody} \gtkw{end} \gntn{blockend}}
  }{Subsystem definition}

  \grule{\gntn{subsysBody}}{
    \glist{\gntn{subsysElement}}
  }{Subsystem body}

  \grule{\gntn{subsysElement}}{
    \gntn{subsystem} \gor \gntn{component} \gor \gntn{events} \gor \gntn{scenarios} \gor \gntn{requirements} \gor \gntn{relation}
  }{Subsystem element}

  \grule{\gntn{subsysImport}}{
    \glist{clientClause} \gopt{\gnc}
    \glist{\gnl} \gtkw{import} \gopt{\gtkw{from} \gntn{name}} blockend
  }{Subsystem import}
  ...
  \grule{\gntn{inheritClause}}{
    \gtkw{inherit} \gntn{name} \glist{\gnl} \glist{\gtkc{,} \glist{\gnl} \gntn{name} \glist{\gnl}}
  }{Inherit clause}

  \grule{\gntn{clientClause}}{
    \gtkw{client} \gntn{name} \glist{\gnl} \glist{\gtkc{,} \glist{\gnl} \gntn{name} \glist{\gnl}}
  }{Client clause}
  ...
  \grule{\gntn{indexEntry}}{
    \gntn{name} \gtkc{:} \gntn{indexValuePart} \glist{\glistnonempty{\gnl} \gntn{indexValuePart}}
  }{Index Entry}
  ...
  \grule{\gntn{component}}{
    \glist{\gnc\gnl}
    \gtkw{component} \gntn{name} \gopt{\gntn{abbrev}} (\gntn{compDef} \gor \gntn{compImport})
  }{Component}
  ...
  \grule{\gntn{relation}}{
    \glist{\gnc\gnl}
    \gtkw{relation} \gntn{name} \glistnonempty{\gntn{inheritClause} \gor \gntn{clientClause}}
    \gopt{\gnc}
    \gntn{blockend}
  ...
  \grule{\gntn{name}}{
    \gntn{nameFacet} \glist{\gtkc{:} \gntn{nameFacet}}
  }{Name}

  \grule{\gntn{nameFacet}}{
  ...
  \grule{\gntn{nonName}}{
    \gtkw{client} \gor \gtkw{inherit} \gor \gtkw{import} \gor \ldots
  }{Keywords}
